...
def read_encoders_data(dataset_num):
...
def read_lidar_data(dataset_num):
...
def read_rgbd_data(dataset_num):
...
# encoder_counts, encoder_stamps = read_encoders_data(20)